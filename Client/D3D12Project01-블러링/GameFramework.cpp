...
CGameFramework::CGameFramework()
{
	...
	_tcscpy_s(m_pszFrameRate, _T("2015182013 변진배 ("));
}
...
void CGameFramework::UpdateShaderVariables()
{
	...
	m_pd3dCommandList->SetGraphicsRootConstantBufferView(GraphicsRoot_Framework, d3dGpuVirtualAddress);
}
...
void CGameFramework::BuildObjects()
{
	...
	pAirplanePlayer->SetTerrain(m_pScene->m_pTerrain);
...
void CGameFramework::ProcessInput()
{
	...
	if (!bProcessedByScene) 
	{
		...
		if (pKeysBuffer[VK_PRIOR] & 0xF0 || pKeysBuffer['Q'] & 0xF0) dwDirection |= DIR_UP;
		if (pKeysBuffer[VK_NEXT] & 0xF0 || pKeysBuffer['E'] & 0xF0) dwDirection |= DIR_DOWN;
