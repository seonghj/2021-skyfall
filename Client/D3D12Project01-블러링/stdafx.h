...
#define MAX_WHIRL_SPEED			100
#define MAX_MAP_HEIGHT			300

#define GraphicsRoot_SkyBox 10
#define GraphicsRoot_Terrain 11
#define GraphicsRoot_Billboard 12
#define GraphicsRoot_Water 13
#define GraphicsRoot_Explosion 15
#define GraphicsRoot_Framework 14
#define GraphicsRoot_Time 16

const XMFLOAT3 c_xmf3Scale(8.0f, 2.0f, 8.0f);
...
extern XMFLOAT3 CubicBezierSum5x5(XMFLOAT3 patch[25]);
extern float* BernsteinCoeffcient5x5(float t);
